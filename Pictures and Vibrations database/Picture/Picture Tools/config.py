...
class AnalysisConfig:
    ...
    def setup_file_paths(self):
        ...
        if self.analysis_type == "tooth1":
            self.RESULTS_FILE = os.path.join(picture_dir, "single_tooth_results.csv")
        elif self.analysis_type == "all_teeth":
            self.RESULTS_FILE = os.path.join(picture_dir, "all_teeth_results.csv")
        elif self.analysis_type == "picture":
            self.SINGLE_TOOTH_RESULTS_FILE = os.path.join(picture_dir, "single_tooth_results.csv")
            self.ALL_TEETH_RESULTS_FILE = os.path.join(picture_dir, "all_teeth_results.csv")
