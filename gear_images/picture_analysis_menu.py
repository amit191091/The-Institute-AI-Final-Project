...
# Add Picture Tools directory to path (works from both gear_images and main directory)
...
def run_tooth1_analysis():
    ...
    try:
        ...
        gear_images_dir = "gear_images/Picture Tools"
...
def plot_results():
    ...
    try:
        ...
        plot_results(single_tooth_data, all_teeth_data)
